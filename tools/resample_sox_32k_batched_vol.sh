...
#
# This variant DOES apply the `vol` gain adjustment. The original 3x
# volume boost is a voltage calibration step, which may push peaks to full
# scale and produced "vol clipped" / "dither clipped" warnings. With no vol
# boost the samples stay in range and those warnings go away. This means
# the output amplitude is not the raw resampled level (3x calibration applied.
#
...
#
# Examples:
#   ./resample_sox_32k_batched_vol.sh 2018 5            # whole month, auto max_jobs
