...
lines += [
    ...
    "The ceilings above are estimates made in July 2026, before most labeling was\n",
    "done. For current counts read the per-month tables at the top of this file,\n",
    "which are generated from the databases; do not rely on the prose here.\n\n",
    "## File Naming\n\n",
    "```\n",
